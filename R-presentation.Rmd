...
- when I get an error message, I'll often remove any specific names of my data and put it directly into Google
- some people like to ask ChatGPT for help in their code
  - "write me an R script to calculate the centered log ratio (CLR) transformation of a vector of counts"
